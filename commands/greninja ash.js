...
module.exports = {
  ...
  $channelSendMessage[$channelID;<@$getChannelVar[lastUser]> {newEmbed: {color:${config.embedcolor}} {description:**__Greninja-Ash detected!__** I've locked the channel for 10 seconds! } {author:$userTag:$authorAvatar}{thumbnail:$serverIcon}}]
  ...
  $onlyIf[$checkContains[$getEmbed[$channelID;$messageid;1;authorname];Vs.​ ​ ​​Greninja-Ash]==true;]
